...
void MainWindow::initUi() {
    ...
    ui.setupUi(this);
    // Ensure zero margins from startup (Designer may reset .ui defaults)
...
void MainWindow::onTrackingTimer() {
    ...
    float v = 0.0f;
    if (h_ratio < 0.45f)      v =  0.6f;   // too far → approach
    else if (h_ratio > 0.60f) v = -0.6f;   // too close → back off
